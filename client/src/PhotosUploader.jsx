...
export default function PhotosUploader({addedPhotos,onChange}) {
    ...
    return (
        ...
        <div className="flex gap-2">
            <input value={photoLink} onChange={ev => setPhotoLink(ev.target.value)} type="text" placeholder={"Add using a link / URL"} />
        ...
        <div className=" mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
            ...
            <label className="h-32 cursor-pointer flex items-center border bg-transparent rounded-2xl p-8 text-2xl text-gray-600">
